...
# Write 3-arg withdraw proof args
...
scarb prove --execute --arguments-file /tmp/withdraw3_args.json 2>&1
echo ""
echo "=== Exit code: $? ==="
echo ""
echo "=== Listing target/execute/: ==="
ls -la target/execute/ 2>&1 || echo "(no execute dir)"
