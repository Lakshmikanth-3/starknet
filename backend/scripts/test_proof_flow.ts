...
async function main() {
    ...
    try {
        ...
        const proofResult = await CryptoService.generateProof(vaultId, amount, randomness, userAddress);
        ...
        const isValid = CryptoService.verifyProof(proofResult.proof, proofResult.publicInputs, commitment);
