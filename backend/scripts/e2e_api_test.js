...
async function main() {
    ...
    const depositRes = await (0, node_fetch_1.default)(`${BASE_URL}/api/vaults`, {
        method: 'POST',
    ...
    const proofRes = await (0, node_fetch_1.default)(`${BASE_URL}/api/vaults/generate-proof`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            vaultId,
    ...
    const travelRes = await (0, node_fetch_1.default)(`${BASE_URL}/api/debug/time-travel`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
    ...
    // 3. Withdraw
    console.log("\n3️⃣  Withdrawing...");
    const withdrawRes = await (0, node_fetch_1.default)(`${BASE_URL}/api/vaults/${vaultId}/withdraw`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            proof,
