...
dotenv.config();
const LOG_FILE = 'deploy_force_blast_detail.log';
// Clear log file
...
async function main() {
    log('🚀 Explicit V3 Deployment (BlastAPI) - FORCE DEPLOY BLAST');
    ...
    try {
        ...
        try {
            ...
            log(`📦 Block fetched: ${block.block_hash}, Status: ${block.status}`);
        }
        catch (e) {
        ...
        const maxPrice = gasPriceL1 * 5n; // 5x safety
        const maxAmount = 500000n; // 500k gas
